...
const ACCOUNTS = {
  ...
  "anilkumar@ksrakshara.org": {
    ...
    "allowedStreams": ["Bio - Maths", "Bio - CS", "Full Portion Exam (FPE)", "Periodic Exam (PE)", "X Harmony", "X Melody", "X Symphony"]
  },
  ...
  "girikumar@ksrakshara.org": {
    ...
    "allowedCodes": ["MAT", "MATH", "Math", "Mathematics"],
    "allowedStreams": ["Maths - CS", "Full Portion Exam (FPE)", "Periodic Exam (PE)", "X Harmony", "X Melody", "X Symphony"]
  },

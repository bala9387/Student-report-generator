...
const ACCOUNTS = {
  "jayganesan@ksrakshara.org": {
    ...
    "allowedStreams": ["Bio - Maths", "Bio - CS", "Maths - CS", "Applied Math", "CS", "Full Portion Exam (FPE)", "Periodic Exam (PE)"]
  },
  "anthony@ksrakshara.org": {
    ...
    "allowedStreams": ["Bio - Maths", "Bio - CS", "Maths - CS", "Full Portion Exam (FPE)", "Periodic Exam (PE)"]
  },
  ...
  "anilkumar@ksrakshara.org": {
    ...
    "allowedStreams": ["Bio - Maths", "Maths - CS", "X Harmony", "X Melody", "X Symphony", "10 H", "10 M", "10 S", "Full Portion Exam (FPE)", "Periodic Exam (PE)"]
  },
  ...
  "dhisounprabu@ksrakshara.org": {
    ...
    "allowedStreams": ["Bio - CS", "Maths - CS", "CS", "X Harmony", "X Melody", "X Symphony", "10 H", "10 M", "10 S", "Full Portion Exam (FPE)", "Periodic Exam (PE)"]
  },

...
const ACCOUNTS = {
  ...
  "dhisounprabu@ksrakshara.org": {
    ...
    "allowedStreams": ["Maths - CS", "Bio - CS", "Full Portion Exam (FPE)", "Periodic Exam (PE)", "X Harmony", "10 H"]
  },
  ...
  "sivakami@ksrakshara.org": {
    ...
    "allowedCodes": ["CS", "Cs", "Computer Science"],
    "allowedStreams": ["Bio - CS", "Maths - CS", "CS", "Applied Math", "Full Portion Exam (FPE)", "Periodic Exam (PE)", "X Melody", "X Symphony", "10 M", "10 S"]
  },
